...
namespace ChinookAPI.Repositories
{
    public interface IChinookRepository
    {
        ...
        Customer CreateCustomer(string firstName, string lastName, string country, string postalCode, string phone, string email);
        Customer UpdateCustomer(int customerId, string updatedPhone, string updatedEmail);
